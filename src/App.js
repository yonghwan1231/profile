        ...
        <section className='profile-info'>
          ...
          <div className='contact-box'>
            <p>
              ...
              <span>010-6248-4837</span>
            </p>
            <p>
              <img src={require('./assets/img/email.png')} />
              <span>coxldtpeo1@naver.com</span>
            </p>
          </div>
        </section>
      ...
      <article className='profile-contents portfolio'>
        ...
        <section className='portfolio-1'>
          ...
          <section className='desc'>
            <h3>의류 쇼핑몰 <span>(개인프로젝트)</span></h3>
            <h4>작업시기 - 2022.12~2022.02</h4>
            ...
            <p className='desc-detail'>
              ...
              <br />
              대부분의 기능이 로그인 상태에서 지원되므로 포트폴리오 확시 시 회원가입 및 로그인을 진행한 후 확인 부탁드립니다.
            </p>
        ...
        <section className='portfolio-2'>
          ...
          <section className='desc'>
            ...
            <h4>작업시기 - 2022.07</h4>
            <div className='link-wrap'>
              <a href='https://web-progress-4y6tt2blds7g9x0.sel3.cloudtype.app/' target='_blank'>
                <img src={require('./assets/img/icon_homepage.png')} />
                사이트 <span className='show-desktop'>방문</span>
              </a>
        ...
        <section className='portfolio-3'>
          ...
          <section className='desc'>
            ...
            <h4>작업시기 - 2022.06</h4>
            <div className='link-wrap'>
              <a href='https://web-userinput-4y6tt2blds7g9x0.sel3.cloudtype.app/' target='_blank'>
                <img src={require('./assets/img/icon_homepage.png')} />
                사이트 <span className='show-desktop'>방문</span>
              </a>
        ...
        <section className='portfolio-4'>
          ...
          <section className='desc'>
            ...
            <h4>작업시기 - 2022.06</h4>
            <div className='link-wrap'>
              <a href='https://web-calender-4y6tt2blds7g9x0.sel3.cloudtype.app/' target='_blank'>
                <img src={require('./assets/img/icon_homepage.png')} />
                사이트 <span className='show-desktop'>방문</span>
              </a>
